...
fontbakery (0.7.27)  - Well designed Font QA tool, written in Python 3
  INSTALLED: 0.4.1
  LATEST:    0.7.27
...
<details>
<summary><b>[161] BodoniModa-Italic[opsz,wght].ttf</b></summary>
<details>
...
* 🔥 **FAIL** The file 'BodoniModa-Italic[opsz,wght].ttf' must be renamed to 'BodoniModa06-Italic[opsz,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* 🔥 **FAIL** First line in license file does not match expected format: "copyright 2020 the bodoni moda project authors"
...
* 🔥 **FAIL** Found a variable font instance with 'wght'=480.0. This should instead be a multiple of 100. [code: bad-coordinate]
* 🔥 **FAIL** Found a variable font instance with 'wght'=740.0. This should instead be a multiple of 100. [code: bad-coordinate]
* 🔥 **FAIL** Found a variable font instance with 'wght'=480.0. This should instead be a multiple of 100. [code: bad-coordinate]
* 🔥 **FAIL** Found a variable font instance with 'wght'=740.0. This should instead be a multiple of 100. [code: bad-coordinate]
* 🔥 **FAIL** Found a variable font instance with 'wght'=480.0. This should instead be a multiple of 100. [code: bad-coordinate]
* 🔥 **FAIL** Found a variable font instance with 'wght'=740.0. This should instead be a multiple of 100. [code: bad-coordinate]
...
* 🔥 **FAIL** Instance "06 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "06 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "11 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "11 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "16 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "16 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "24 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "24 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "36 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "36 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "48 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "48 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "72 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "72 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "96 Medium Italic" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "96 Bold Italic" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
...
* ⚠ **WARN** Instance "06 Italic": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "06 Medium Italic": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "06 Bold Italic": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "06 Black Italic": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Black Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Italic": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Medium Italic": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Bold Italic": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Black Italic": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Black Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Italic": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Medium Italic": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Bold Italic": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Black Italic": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Black Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Italic": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Medium Italic": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Bold Italic": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Black Italic": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Black Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Italic": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Medium Italic": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Bold Italic": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Black Italic": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Black Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Italic": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Medium Italic": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Bold Italic": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Black Italic": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Black Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Italic": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Medium Italic": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Bold Italic": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Black Italic": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Black Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Italic": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Medium Italic": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Medium Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Bold Italic": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Bold Italic": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Black Italic": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Black Italic": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** The following spacing glyphs may be in the GDEF mark glyph class by mistake:
	 breve, caron, cedilla, circumflex, dieresis, dotaccent, ogonek, ring and tilde [code: spacing-mark-glyphs]
...
* ⚠ **WARN** The following mark characters could be in the GDEF mark glyph class:
	 U+0302, U+0303, U+0306, U+0307, U+0308, U+030A, U+030B, U+030C, U+0327 and U+0328 [code: mark-chars]
...
* ⚠ **WARN** The following non-mark characters should not be in the GDEF mark glyph class:
	 U+00A8, U+00B8, U+02C6, U+02C7, U+02D8, U+02D9, U+02DA, U+02DB, U+02DC and U+02DD [code: non-mark-chars]
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 2.2'] [code: version-not-detected]
...
* ℹ **INFO** Version string is: "Version 2.2"
...
|:----- |:----- |:-------------- |
| Postscript Name | Bodoni-Moda-06-Book-Italic | May contain not more than a single hyphen |
 [code: bad-entries]
...
* 🍞 **PASS** OS/2 VendorID 'it* ' looks good!
...
* 🍞 **PASS** Name Table entry: Copyright field 'Copyright 2020 The Bodoni Moda Project Authors (https://github.com/indestructible-type)' matches canonical pattern.
...
<details>
<summary><b>[161] BodoniModa[opsz,wght].ttf</b></summary>
<details>
<summary>🔥 <b>FAIL:</b> Checking file is named canonically.</summary>
...
* 🔥 **FAIL** The file 'BodoniModa[opsz,wght].ttf' must be renamed to 'BodoniModa06[opsz,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* 🔥 **FAIL** Instance "06 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "06 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "11 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "11 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "16 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "16 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "24 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "24 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "36 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "36 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "48 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "48 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "72 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "72 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "96 Medium" wght value is "480.0". It should be "500.0" [code: bad-coordinate]
* 🔥 **FAIL** Instance "96 Bold" wght value is "740.0". It should be "700.0" [code: bad-coordinate]
* 🔥 **FAIL** Check has either failed or produced a warning. See our wip spec for further info https://gist.github.com/m4rc1e/8f4c4498519e8a36cd54e16a004275cb
...
* ⚠ **WARN** Instance "06 Regular": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "06 Medium": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "06 Bold": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "06 Black": contains the following unparsable tokens "['06']"
* ⚠ **WARN** Instance "06 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Regular": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Medium": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Bold": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "11 Black": contains the following unparsable tokens "['11']"
* ⚠ **WARN** Instance "11 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Regular": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Medium": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Bold": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "16 Black": contains the following unparsable tokens "['16']"
* ⚠ **WARN** Instance "16 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Regular": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Medium": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Bold": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "24 Black": contains the following unparsable tokens "['24']"
* ⚠ **WARN** Instance "24 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Regular": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Medium": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Bold": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "36 Black": contains the following unparsable tokens "['36']"
* ⚠ **WARN** Instance "36 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Regular": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Medium": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Bold": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "48 Black": contains the following unparsable tokens "['48']"
* ⚠ **WARN** Instance "48 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Regular": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Medium": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Bold": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "72 Black": contains the following unparsable tokens "['72']"
* ⚠ **WARN** Instance "72 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Regular": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Medium": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Bold": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "96 Black": contains the following unparsable tokens "['96']"
* ⚠ **WARN** Instance "96 Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Check has either failed or produced a warning. See our wip spec for further info https://gist.github.com/m4rc1e/8f4c4498519e8a36cd54e16a004275cb
...
| Field | Value | Recommendation |
|:----- |:----- |:-------------- |
| Postscript Name | Bodoni-Moda-06-Regular | May contain not more than a single hyphen |
 [code: bad-entries]
